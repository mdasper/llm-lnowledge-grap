...
llm = ChatVertexAI(
    model_name="gemini-2.5-flash-lite",  # or "gemini-pro"
    temperature=0,
...
# Graph transformer with allowed node types
doc_transformer = LLMGraphTransformer(
    llm=llm,
    allowed_nodes=["Technology", "Concept", "Skill", "Event", "Person", "Object"],
    # Optional: Uncomment below to restrict relationships and properties
...
for chunk in chunks:
    ...
    # Generate graph documents with allowed nodes
