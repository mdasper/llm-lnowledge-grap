...
# Initialize two Vertex AI LLMs
qa_llm = ChatVertexAI(
    model_name="gemini-2.5-flash-lite",  # Used for answering the question
    temperature=0,
    project=GOOGLE_CLOUD_PROJECT,
    location=GOOGLE_CLOUD_LOCATION
)

cypher_llm = ChatVertexAI(
    model_name="gemini-2.5-flash-lite",  # Used for generating Cypher queries
    temperature=0,
    project=GOOGLE_CLOUD_PROJECT,
    location=GOOGLE_CLOUD_LOCATION
)
...
# Create the Cypher QA chain using two LLMs
